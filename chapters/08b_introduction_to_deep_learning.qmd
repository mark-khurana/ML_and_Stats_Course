...
- **Weight decay (L2 regularization)**: Gently penalise large weights, exactly as in ridge regression, to keep the model from over-relying on any one input.
