...
logit = (-3
         + 0.02 * (df['age'] - 68)
         + 0.15 * df['prior_admissions']
         + 0.10 * df['num_comorbidities']
         + 0.30 * df['has_chf']
         - 0.10 * (df['discharge_hemoglobin'] - 11))
