...
These three exercises work through the same development pipeline this chapter built, on the simulated Framingham data above. They are extended practice tasks rather than short questions, so no worked solutions are given --- the chapter's own code is the model to follow.
...
a) Compare which variables each approach selects.
