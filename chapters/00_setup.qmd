...
* Go to https://github.com/mark-khurana/ML_and_Stats_Course
...
```{bash}
git clone https://github.com/mark-khurana/ML_and_Stats_Course.git
```
...
- Johnson, J., Karpathy A., and contributors (2021). *Python Numpy Tutorial (with Jupyter and Colab)*. Tutorial from the Stanford course CS231n: Deep Learning for Computer Vision. Freely available at <https://cs231n.github.io/python-numpy-tutorial/>. A concise and practical introduction to NumPy.

- McKinney, W. (2022). *Python for Data Analysis: Data Wrangling with pandas, NumPy, and Jupyter* (3rd ed.). O'Reilly Media. Freely available at <https://wesmckinney.com/book/>. The authoritative guide to pandas, written by the creator of the library.
